  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      if (args[0]) {
        ...
        let button_dc = new MessageButton().setStyle('url').setLabel('Support Server').setURL("https://discord.gg/GGmCvgAgYb")
        let button_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("https://discord.gg/GGmCvgAgYb")
        ...
        let FIRSTEMBED = new MessageEmbed()
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter("Page Home\n" + client.user.username + " | Yuzence OP, Rahul OP ", client.user.displayAvatarURL())
...
📶 **\`${Math.floor(client.ws.ping)}ms\` Ping**`)
        ...
        let d_button_dc = new MessageButton().setStyle('url').setLabel('Get your Own Bot').setURL("itsnotpublic.com");
        let d_button_invite = new MessageButton().setStyle('url').setLabel('Invite Public Version').setURL("no.com");
      ...
      function allotherembeds() {
        ...
        var embed5 = new MessageEmbed()
          ...
          .addField(`> ***[Billi Development](https://discord.gg/GGmCvgAgYb)***\n>`)
          .addField(`<:Milrato:840259659163893820> **__Bot Creator Information__**`, `>>> 💯 This Bot has been made by Cat :\n[Discord](https://discord.gg/h89J49AB)<:Discord:787321652345438228>`)
          .setFooter(`Page 6 / 6  \nTo see command Descriptions and Information, type: ${config.prefix}help [CMD NAME]`, client.user.displayAvatarURL());
        embeds.push(embed5)
        return embeds
      }
